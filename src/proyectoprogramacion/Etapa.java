...
public class Etapa {
    ...
    public void definirGanador() {
        ...
        Collections.sort(listaCiclistas, Comparator.comparingInt(Ciclista::getS_puntos));
        ...
        System.out.println("El ganador de la etapa es: " + ganador.getNombre() +
                ...
                " con un tiempo de " + ganador.getS_puntos() + " minutos");
    }
    ...
    public void mostrarResultados() {
        ...
        int tiempoGanador = listaCiclistas.get(0).getS_puntos();

        for (int i = 0; i < listaCiclistas.size(); i++) {
            Ciclista ciclista = listaCiclistas.get(i);
            int segundosFaltantes = ciclista.getS_puntos() - tiempoGanador;

            System.out.println(
                    (i + 1) + ". " +
                            "Nombre: " + ciclista.getNombre() +
                            ", Equipo: " + ciclista.getEquipo() +
                            ", Tiempo (s_puntos): " + ciclista.getS_puntos() +
                            ", Segundos detrás del ganador: " + segundosFaltantes +
                            ", Puntos por Montaña (m_puntos): " + ciclista.getM_puntos()
            );
        }
    }
}